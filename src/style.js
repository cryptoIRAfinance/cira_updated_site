const styles = {
  ...
  form: {display: "flex", flexDirection: "column", alignItems: "center", width: "100%", marginBottom: "20px", },
  input: {width: "75%", height: "40px", border: "none", borderRadius: "10px", backgroundColor: "#1e3a64", color: "white", fontSize: "16px", marginBottom: "5px", alignItems: "center"  },
  ...
  label: {fontSize: '16px', color: '#fac25f', marginTop: "10px", },
