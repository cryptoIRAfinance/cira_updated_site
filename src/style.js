const styles = {
  ...
  input: {width: "75%", height: "40px", border: "none", borderRadius: "10px", backgroundColor: "#1e3a64", color: "white", fontSize: "16px", marginBottom: "5px", marginTop: "10px", alignItems: "center"  },
