const styles = {
  ...
  form: {display: "justify-center", flexDirection: "column", alignItems: "center", width: "100%", margin: "0 auto", marginBottom: "20px" },
  input: {width: "50%", height: "40px", border: "none", borderRadius: "5px", backgroundColor: "cornflowerblue", color: "white", fontSize: "16px", marginBottom: "20px", alignItems: "center"  },
